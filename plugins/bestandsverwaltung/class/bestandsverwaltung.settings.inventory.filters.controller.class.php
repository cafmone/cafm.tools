<?php
/**
 * bestandsverwaltung_settings_inventory_filters_controller
 *
...
class bestandsverwaltung_settings_inventory_filters_controller
{
/**
...
* @var string
*/
var $actions_name = 'settings_filters_action';
/**
* message param
* @access public
* @var string
*/
var $message_param = 'settings_filters_msg';
/**
* identifier
* @access public
* @var string
*/
var $identifier_name = 'settings_filters_ident';
/**
* inventory filter
* @access public
* @var bool
...
var $lang = array();
	...
	function action($action = null) {
		...
		if(!isset($this->db->type)) {
			...
			switch( $this->action ) {
				default:
				case 'custom':
					$data[] = $this->custom(true);
					#$data[] = $this->groups();
				break;
				case 'groups':
					$data[] = $this->custom();
					$data[] = $this->groups(true);
				break;
			}
		}
	 ...
	 */
	//--------------------------------------------
	function custom($visible = false) {
		$data = '';
		if($visible === true) {
			require_once($this->classdir.'bestandsverwaltung.settings.inventory.filters.custom.class.php');
			$controller = new bestandsverwaltung_settings_inventory_filters_custom($this);
	...
	function groups($visible = false) {
		$data = '';
		if($visible === true) {
			require_once($this->classdir.'bestandsverwaltung.settings.inventory.filters.groups.class.php');
			$controller = new bestandsverwaltung_settings_inventory_filters_groups($this);
			$controller->message_param = $this->message_param;
			$controller->actions_name = $this->actions_name;
			$controller->tpldir = $this->tpldir;
			$controller->lang = $this->lang;
