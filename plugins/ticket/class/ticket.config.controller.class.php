...
class ticket_config_controller
{
/**
...
* @var string
*/
var $actions_name = 'ticket_config_action';
/**
* message param
* @access public
* @var string
*/
var $message_param = 'ticket_config_msg';

var $prefix_tab = 'ticket_config_tab';
/**
* translation
* @access public
* @var string
...
var $lang = array(
	...
	function settings( $visible = false ) {
		$data = '';
		if( $visible === true ) {
			require_once($this->classdir.'ticket.config.settings.class.php');
			$controller = new ticket_config_settings($this);
	...
	function email( $visible = false ) {
		$data = '';
		if( $visible === true ) {
			require_once($this->classdir.'ticket.config.email.class.php');
			$controller = new ticket_config_email($this);
			$controller->actions_name = 'ticket_email_action';
			$controller->message_param = $this->message_param;
			$controller->tpldir = $this->tpldir;
			$data = $controller->action();
		}
	...
	function form( $visible = false ) {
		$data = '';
		if( $visible === true ) {
			require_once($this->classdir.'ticket.config.form.class.php');
			$controller = new ticket_config_form($this);
