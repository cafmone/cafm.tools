...
var $lang = array(
	...
	'path' => 'Path',
	'required' => 'required',
	'saved' => 'Tasks Settings have been saved',
...
var $tpldir = '';
	...
	function __construct( $controller ) {
		...
		$this->lang       = $this->user->translate($this->lang, CLASSDIR.'plugins/tasks/lang/', 'tasks.config.settings.ini');
	}
	...
	function action($action = null) {
		...
		switch( $this->action ) {
			...
			case 'update':
				...
				$t = $response->html->template($this->tpldir.'tasks.config.settings.html');
				$t->add($vars);
				$t->add($response->form);
