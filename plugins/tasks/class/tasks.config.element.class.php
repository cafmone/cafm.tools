	...
	function action($action = null) {
		...
		switch( $this->action ) {
			...
			case 'select':
				...
				$t = $response->html->template($this->tpldir.'tasks.config.element.select.html');
				$t->add($vars);
				$t->add($response->form);
			...
			case 'insert':
				...
				$t = $response->html->template($this->tpldir.'tasks.config.element.insert.html');
				$t->add($vars);
				$t->add($response->form);
				$t->group_elements(array('param_' => 'form'));
				return $t;
			...
			case 'update':
				...
				$t = $response->html->template($this->tpldir.'tasks.config.element.update.html');
				$t->add($vars);
				$t->add($response->form);
				$t->group_elements(array('param_' => 'form'));
				return $t;
			...
			case 'sort':
				...
				$t = $response->html->template($this->tpldir.'tasks.config.element.sort.html');
				$t->add($vars);
				$t->add($response->form);
				$t->group_elements(array('param_' => 'form'));
				return $t;
			...
			case 'delete':
				...
				$t = $response->html->template($this->tpldir.'tasks.config.element.delete.html');
				$t->add($vars);
				$t->add($response->form);
				$t->group_elements(array('param_' => 'form'));
				return $t;
